...
$script:REQUIRED_VARS  = @('CONTEXT7_API_KEY','NPM_TOKEN','OC_USAGE_DIR','GIT_NAME','GIT_EMAIL','GIT_EDITOR')
$script:OPTIONAL_VARS  = @('OPENROUTER_API_KEY','NVIDIA_API_KEY','OPENCODE_API_KEY','OPENCODE_GO_KEY')
